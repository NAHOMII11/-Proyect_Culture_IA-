	...
	useEffect(() => {
		...
		const loadRanking = async () => {
			try {
				...
				const response = await fetch(API.bff.ranking, {
				...
				if (fetchError.name !== 'AbortError') {
					setError('No se pudo cargar el ranking. Verifica que el BFF (gateway) esté disponible.')
				}
			} finally {
				setLoading(false)
			}
				...
				<section className="hero">
					<div>
						...
						<p className="hero-text">
							Esta vista consulta el BFF consolidado y presenta los lugares
