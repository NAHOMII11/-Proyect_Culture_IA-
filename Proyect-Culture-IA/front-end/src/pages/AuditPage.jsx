...
const EVENT_TYPES = [
  { value: 'importacion_procesada', label: 'Importación procesada' },
  { value: 'lugar_enriquecido', label: 'Lugar enriquecido' },
  { value: 'puntuacion_calculada', label: 'Puntuación calculada' },
  { value: 'ruta_generada', label: 'Ruta generada' },
  { value: 'consulta_asistente', label: 'Consulta asistente' },
  { value: 'coordenadas_asignadas', label: 'Coordenadas asignadas' },
  { value: 'lugar_creado', label: 'Lugar creado' },
  { value: 'recomendacion_generada', label: 'Recomendación generada' },
]
                  ...
                  <tbody>
                    {items.map((event) => (
                      <tr key={event.id}>
                        ...
                        <td>
                          <span className="badge">{formatEventType(event.event_type)}</span>
                        </td>
          ...
          >
            ...
            {detailLoading ? (
              ...
              <dl className="audit-detail-list">
                ...
                <dt>Tipo</dt>
                <dd>{formatEventType(selected.event_type)}</dd>
                <dt>Servicio</dt>
