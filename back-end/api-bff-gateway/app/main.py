...
from app.routers.bff_advanced import router as bff_advanced_router  # S3-H5
...
# ── Manejadores globales de error (S3-H5) ─────────────────────────────────────
...
app.include_router(bff_advanced_router)   # S3-H5: endpoints avanzados
